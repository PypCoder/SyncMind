...
class SyncMindApp(tk.Tk):
    ...
    def create_the_pulse_frame(self):
        ...
        tk.Text(self.the_pulse_frame, height=8, width=60, font=("Arial", 12), bg="#f7f7f7", relief="solid").pack(pady=5)

        tk.Label(self.the_pulse_frame, text="📈 Live Feed & Insights", font=("Arial", 16, "bold"), bg="#ffffff").pack(pady=10)
        tk.Text(self.the_pulse_frame, height=6, width=60, font=("Arial", 12), bg="#f7f7f7", relief="solid").pack(pady=5)

        tk.Button(self.the_pulse_frame, text="✨ Launch AutoPilot", command=self.autopilot_action,
                  font=("Arial", 12), bg="#0077cc", fg="white", width=20).pack(pady=15)
    ...
    def create_autopilot_frame(self):
        ...
        tk.Button(self.autopilot_frame, text="▶ Start Task", font=("Arial", 12),
                  bg="#28a745", fg="white", width=20, command=self.start_action).pack(pady=20)
